''' This rsync implementation is from Tyler Cipriani's blog
(https://tylercipriani.com/blog/2017/07/09/the-rsync-algorithm-in-python/).
All rights reserved to him as this is primarily his work, being used here for
testing and learning. This may change later for liscence issues and to have
an original working implementation of rsync.
Right now, this is as is in his blog.
...
class Chunks(object):
    ...
    def get_chunk(self, chunk):
        adler32 = self.chunk_sigs.get(adler32_chunk(chunk.encode()))
